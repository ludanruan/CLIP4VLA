...
INIT_MODEL="../UniVL/ckpts/ckpt_msrvtt_video_retrieval/pre_compare/pytorch_model.bin.8"
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port=25104 \
main_task_video_retrieval.py --do_eval  --num_thread_reader=4 --filter_video_id \
...
--output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_video_retrieval/t2t  \
--datatype ${DATATYPE} \
