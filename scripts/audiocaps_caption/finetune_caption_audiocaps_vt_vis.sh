...
INIT_MODEL="ckpts/ckpt_audiocaps_visual_caption/for_vis/pytorch_model.bin.8"
...
--do_eval  --pretrained_clip_name ViT-B/32 --num_thread_reader=4 \
...
--output_dir ${OUTPUT_ROOT}/ckpt_audiocaps_visual_caption/for_vis \
...
# --raw_video_path ${VIDEO_PATH} \
# --features_path ${FEATURES_PATH} \
# --output_dir ${OUTPUT_ROOT}/ckpt_audiocaps_visual_caption/for_vis_2 \
