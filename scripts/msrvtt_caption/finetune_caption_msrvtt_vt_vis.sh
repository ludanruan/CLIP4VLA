...
INIT_MODEL="ckpts/ckpt_msrvtt_visual_caption/for_vis/pytorch_model.bin.4"
CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1  --master_port=25401 \
main_task_visual_caption.py \
--do_eval   --pretrained_clip_name ViT-B/32 --num_thread_reader=0 \
...
--output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_visual_caption/for_vis \
...
# --raw_video_path ${VIDEO_PATH} \
# --features_path ${FEATURES_PATH} \
# --output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_visual_caption/for_vis_2 \
