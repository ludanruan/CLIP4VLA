...
INIT_MODEL="ckpts/ckpt_msrvtt_video_caption/for_vis/pytorch_model.bin.4"
...
--output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_video_caption/for_vis \
...
# --raw_video_path ${VIDEO_PATH} \
# --features_path ${FEATURES_PATH} \
# --output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_video_caption/for_vis_2 \
