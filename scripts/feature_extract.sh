...
#VAL_CSV="data/msrvtt/MSRVTT_train_longest_cap.csv"
VAL_CSV="data/msrvtt/MSRVTT_train9k_no_audio.txt"
...
--output_dir ${OUTPUT_ROOT}/ckpt_msrvtt_video_retrieval/train_feat_noaudio \
--datatype ${DATATYPE} \
