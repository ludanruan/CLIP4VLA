...
VAL_CSV="data/vatex/test_retrieval.csv"
...
--with_control_token 0.5 --filter_video_id --retrieval_finetune loose_seq --train_sim_after_cross \
...
--raw_video_path ${VIDEO_PATH} \
--audio_path ${AUDIO_PATH}  \
--output_dir ${OUTPUT_ROOT}/ckpt_vatex_audio_retrieval/pre_compare  \
--datatype ${DATATYPE} \
--lr 5e-4 --max_words 32 --max_frames 12 --batch_size_val 128 \
--feature_framerate 1 --coef_lr 2e-4  \
--freeze_layer_num -1  --slice_framepos 2  \
